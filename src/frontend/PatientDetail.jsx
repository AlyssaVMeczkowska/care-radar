    ...
    return (
      <div className="min-h-screen bg-gradient-to-br from-purple-50 via-pink-50 to-blue-50 flex items-center justify-center">
        <div className="flex flex-col items-center gap-4">
          ...
          <p className="text-purple-400">Loading patient details...</p>
        </div>
      </div>
    );
  }
    ...
    return (
      <div className="min-h-screen bg-gradient-to-br from-purple-50 via-pink-50 to-blue-50 flex items-center justify-center">
        <div className="text-center">
          <p className="text-purple-600 mb-4">Patient not found</p>
          <button onClick={onBack} className="px-4 py-2 bg-purple-400 text-white rounded-xl">
            Go Back
          </button>
        </div>
      </div>
            ...
            <div className="bg-gradient-to-br from-purple-400/20 to-pink-400/20 backdrop-blur-md rounded-3xl p-6 shadow-xl border border-purple-200/50">
              <div className="flex items-start gap-4">
                ...
                <div>
                  ...
                  <p className="text-purple-700 leading-relaxed">{patient.aiSummary}</p>
                </div>
              </div>
            </div>

            {/* Care Gaps */}
            {patient.careGaps && patient.careGaps.length > 0 && (
              <div className="bg-white/70 backdrop-blur-md rounded-3xl p-6 shadow-xl border border-purple-100/50">
                <div className="flex items-center justify-between mb-4">
                  <h3 className="text-lg font-semibold text-purple-900">Care Gaps</h3>
                  <span className="px-3 py-1 bg-red-100 text-red-600 rounded-full text-sm font-medium">
                    {patient.careGaps.filter(g => g.status === 'overdue').length} Overdue
                  </span>
                </div>
                <div className="space-y-3">
